...
return [
    ...
    'expense' => [
        ...
        'system' => [
            ...
            ['key' => 'Stok Opname Minus', 'pnl' => true, 'filter' => 'cash_movement'],
            ['key' => 'Penyesuaian Kas',   'pnl' => true, 'filter' => 'cash_movement'],
            ['key' => 'Pending EDC',       'pnl' => false, 'filter' => 'cash_movement'],
            ['key' => 'OMSET',             'pnl' => true,  'filter' => 'cash_movement'],
            ['key' => 'Retur Penjualan',   'pnl' => true,  'filter' => 'cash_movement'],
        ],
    ],
    ...
    'income' => [
        ...
        'system' => [
            ...
            ['key' => 'Stok Opname Plus',  'pnl' => true,  'filter' => 'real'],
            ['key' => 'Penyesuaian Kas',   'pnl' => true,  'filter' => 'real'],
            ['key' => 'Retur Pembelian',   'pnl' => true,  'filter' => 'real'],
            ['key' => 'OMSET',             'pnl' => true,  'filter' => 'cash_movement'],
